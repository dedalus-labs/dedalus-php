 ...
 *
 * @see Dedalus\Services\UsageService::machineStorage()
 *
 * @phpstan-type UsageMachineStorageParamsShape = array{
 *   machineID?: string|null, periodEnd?: string|null, periodStart?: string|null
 * }
 */
final class UsageMachineStorageParams implements BaseModel
{
    /** @use SdkModel<UsageMachineStorageParamsShape> */
    use SdkModel;
    use SdkParams;
