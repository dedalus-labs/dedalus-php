 ...
 * List executions.
 *
 * @see Dedalus\Services\Machines\ExecutionsService::list()
 *
...
final class ExecutionListParams implements BaseModel
{
    ...
    /**
     * `new ExecutionListParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ExecutionListParams::with(machineID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ExecutionListParams)->withMachineID(...)
     * ```
     */
